...
\usepackage[pdfusetitle, unicode, linkbordercolor=tugreen, citebordercolor=tugreen]{hyperref}  %TODO: correct upper and lower cases for references
\usepackage{cleveref}
\usepackage{bookmark}
