...
\documentclass[
  ...
  BCOR=12mm, %TODO: binding corrections?     % 12mm binding corrections, adjust to fit your binding
  parskip=half, %TODO: paragraphs style  % new paragraphs start with half line vertical space
...
\usepackage[pdfusetitle, unicode, linkbordercolor=tugreen, citebordercolor=tugreen]{hyperref} %TODO: highligh links/references?  %TODO: correct upper and lower cases for references
\usepackage{bookmark}
...
\mainmatter %TODO: in general "" or italic missing for names?
% display textwidth:
