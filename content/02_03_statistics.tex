...
The objective of any \emph{classification algorithm} is to assign a class to each given data point so that some property is shared among all data points in a class.
