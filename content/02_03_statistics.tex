...
The underlying concept of a DeepSet is the function % is that a function is invariant under permutations of the instances $x$ in a set $X$ if it can be written in the form %TODO: Satzanfang
\begin{equation*}
