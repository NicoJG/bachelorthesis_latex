...
%
Cone-isolation refers to an isolation metric of a track which is evaluated based on how many neighbouring tracks are inside a defined cone in the $\eta$-$\phi$-plane around the track in question. %TODO: "how is the cone isolation variable defined. Is the variable a length or angle (size of cone?). Is it kind of a probability of tracks or a counter of tracks for a fixed cone size (if yes, what is the size of the cone)? Please explain this."
SumBDT,    
MinBDT and    
...
The error rate is the proportion of predictions matching the true labels of the simulation. %TODO: ground truth is wrong?
