\section{\texorpdfstring{$B$}{B} meson production in proton-proton collisions} %TODO: B bold
\label{sec:B_mesons}
...
These $b$ quarks then hadronize by combining with other quarks that emerge from the vacuum in pairs. %TODO: emerge
This then also produces fragmentation particles through further hadronization of the unpaired quarks.

A frequent goal at LHCb is to analyse $pp$-collisions for $B$ meson candidates, often called the signal~$B$. %TODO: frequent goal
...
Therefore, it is expected that only the SS fragmentation contains relevant information for this thesis. %TODO: OS argument correct? 
