...
A classification algorithm is developed in this thesis for the distinction between neutral $B_d$ and $B_s$ mesons in $pp$-collisions. %TODO: pp or proton-proton?
This algorithm uses data of tracks associated with the signal $B$ meson without data of the signal decay. 
The machine learning models used in this thesis are trained on simulated data. %TODO: of the LHCb detector? vgl. deutsche Version
...
\begin{foreignlanguage}{german}
    ...
    Die Evaluierung dieses Algorithmus(ses?) auf simulierten Daten zeigt eine klare erreichte Trennung zwischen den beide $B$ Meson Arten. %TODO: Algorithmusses?
