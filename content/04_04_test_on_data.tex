...
\begin{figure}
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \caption{Fit of the simulated $B_d$ invariant mass}
        \label{fig:fit_mc}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
    ...
    \end{subfigure}%
    \caption{The left figure shows a fit on a simulated $B_d$ sample. The right figure shows a fit of the $B$ mass distribution with the selection $\text{Prob}_{B_s} \geq 0.43919$. Both figures also show a pull distribution between the data points and the fit.}
\end{figure}
