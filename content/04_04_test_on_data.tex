...
IP$(x)$ is the impact parameter to the production vertex of $x$.
$p_\text{T}(x)$ is the transversal momentum of $x$.
$\eta(x)$ is the pseudorapidity of $x$.
$p_z(x)$ is the momentum of $x$ along the $z$-axis.
FD$(x)$ is the flight distance from the production vertex to the decay vertex.
