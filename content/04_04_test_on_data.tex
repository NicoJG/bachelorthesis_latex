...
The procedure used for background reduction is based on a work-in-progress analysis on the \enquote{Measurement of $\sin(2\beta)$ in $B^0\rightarrow J/\psi \, K^0_\text{S}$ decays with run 2 data} and is explained here only briefly. %TODO: + in decays?
