...
Such an algorithm could be used in other studies to reduce some types of background of $B_d$ or $B_s$ mesons.
This includes mainly \enquote{partial backgrounds} where missing information on the signal decay kinematics leads to an insufficient background reduction.
Other types of background are also conceivable where simple cuts on the signal decay kinematics do not result in a sufficient background reduction.
