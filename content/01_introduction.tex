...
Such an algorithm could be used in other studies to reduce backgrounds from $B$ mesons of another type than the signal. %TODO:mention examples %to reduce some types of background of $B_d$ or $B_s$ mesons.
